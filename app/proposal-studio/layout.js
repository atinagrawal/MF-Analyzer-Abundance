...
export default function ProposalStudioLayout({ children }) {
  const webApp = {
    ...
    "description": "Build a mutual fund or SIF investment proposal with combined sector/security exposure, fund overlap detection, and Large/Mid/Small-cap allocation using AMFI's official categorization.",
    ...
    "featureList": [
      ...
      "Combined security exposure with full-holdings view",
      "Pairwise fund overlap detection across named holdings (stocks, bonds, REITs, gold/other ETFs)",
