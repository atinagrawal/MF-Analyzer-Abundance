...
//
// inferExitLoadCategory, formatTierPeriod, and getExitLoadInfo moved to
// lib/exitLoad.js (imported above) so components/RedemptionPlanner.jsx can
// use the exact same detection logic -- see that file's header comment.
...
// calcLotExitLoad moved to lib/exitLoad.js (imported above).
...
{/* ── Merged totals including manual holdings ── */}
      ...
      {planFund && <RedemptionPlanner fund={planFund} masterFacts={masterFacts} onClose={() => setPlanFund(null)} />}
      {txnDrawerFund && (
