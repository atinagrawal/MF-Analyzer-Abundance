...
const VALID_INDICES = new Set([
  ...
  // Thematic sectors
  'NIFTY INDIA DEFENCE', 'NIFTY CHEMICALS', 'NIFTY CONSUMER DURABLES',
  'NIFTY CAPITAL MARKETS', 'NIFTY EV & NEW AGE AUTOMOTIVE',
  'NIFTY INDIA MANUFACTURING', 'NIFTY TRANSPORTATION & LOGISTICS',
  'NIFTY PRIVATE BANK', 'NIFTY HOUSING', 'NIFTY INDIA RAILWAYS PSU',
]);
