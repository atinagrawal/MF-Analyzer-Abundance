/**
 * app/api/og-book-consultation/route.js
 *
 * OG image for /book-consultation — returned as PNG via @vercel/og
    ...
    (
      ...
      >
        ...
        <div style={{
          ...
          <span>Talk to a Real Advisor,</span>
          <span style={{ color: '#a5d6a7' }}>Free — No Obligation</span>
        </div>
        ...
        <div style={{
          ...
          Book a free 30-minute call to plan your mutual funds, SIP, SWP, SIF or PMS —
          no forms, no fine print, just a conversation.
        </div>

        {/* Feature pills */}
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
          {['30 Min · Free', '15+ Yrs Experience', '350+ Clients', '₹250Cr+ AUM', 'No Obligation'].map(f => (
            <div key={f} style={{
        ...
        <div style={{
          ...
          mfcalc.getabundance.in/book-consultation
        </div>
      </div>
    ),
    {
