...
const COLS = 'code,isin,name,amc,category,structure,nav,nav_date,ret_1m,ret_3m,ret_6m,ret_1y,ret_3y,ret_5y,ret_7y,ret_10y,vol,max_dd,ret_per_risk,age_years,inception_date,ret_inception,flag,asof';
...
export async function GET() {
  try {
    ...
    const funds = rows.map((r) => ({
      code: r.code, isin: r.isin || null, name: r.name, amc: r.amc, category: r.category, structure: r.structure,
