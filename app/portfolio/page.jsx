/**
 * app/portfolio/page.jsx — Client Portfolio Portal (Server Component Wrapper)
 *
 * Exports metadata and JSON-LD schema specifically for the /portfolio dashboard,
 * keeping child routes (like /portfolio/diagnostic/[share_token]) clean of
 * unrelated schema and canonical URL collisions.
 */
