...
import PmsPreferredInteractive from './PmsPreferredInteractive';
      ...
      <main className="pmspref-main">
        ...
        {strategies.length > 0 && (
          <>
            ...
            <PmsPreferredInteractive strategies={strategies} insights={insights} spotlight={spotlight} asOn={asOn} />
