...
/* ── JSON-LD Schemas ─────────────────────────────────────────────────── */
// Refreshed at build/deploy time so `dateModified` tracks the last release
// rather than needing a hand-edited date on every change.
const BUILD_DATE = new Date().toISOString().slice(0, 10);

const SCHEMA_WEB_APP = {
  "@context": "https://schema.org",
  "@type": "WebApplication",
  "name": "MF Analyzer — SIP, SWP Backtester, Fund Compare & EMI",
  "alternateName": "MF Analyzer by Abundance",
  "url": "https://mfcalc.getabundance.in/",
  "description": "Free all-in-one financial calculator. SIP NAV Backtester and SWP NAV Backtester using real historical fund NAVs with XIRR. Compare MF returns & Sharpe ratio. Goal planner. EMI calculator. Live AMFI NAV data. By Abundance Financial Services ARN-251838.",
  "applicationCategory": "FinanceApplication",
  "operatingSystem": "Any",
  "browserRequirements": "Requires JavaScript",
  "offers": { "@type": "Offer", "price": "0", "priceCurrency": "INR" },
  "featureList": [
    "Mutual Fund Comparison — up to 5 funds simultaneously",
    "Interactive NAV Growth Chart with Custom Date Selection & Return Measurement",
    "Arbitrary Historical Period Return Calculator",
    "Live Verified AMFI NAV Data",
    "Risk Table — 1M, 3M, 1Y, 3Y, 5Y returns per fund",
    "Sharpe Ratio, Annualised Volatility & Max Drawdown (5Y or full history)",
    "SIP Returns Calculator with Step-up SIP",
    "Lumpsum Investment Calculator",
    "Investment Goal Planner — SIP, lumpsum or hybrid",
    "SWP — Systematic Withdrawal Plan with corpus longevity analysis",
    "EMI Calculator for Home, Car & Personal Loans",
    "Loan Prepayment Analyser with Interest Savings",
    "Balance Transfer Analyser for Loans",
    "Year-by-Year Amortisation Schedule",
    "SIP NAV Backtester — backtest monthly SIP against real historical NAV data with XIRR",
    "SWP NAV Backtester — replay SWP against real historical fund NAV data",
    "XIRR calculation on actual SWP cashflows",
    "What-if start-year comparison table for SWP",
    "Delay/accumulation phase with real NAV growth before SWP",
    "Shareable SWP Backtester URLs with dynamic OG image",
    "Discontinued AMC filtering (13 wound-down fund houses hidden by default)",
    "State-wise India map",
    "Geographic AUM distribution"
  ],
  "audience": { "@type": "Audience", "audienceType": "Individual investors, loan seekers, financial planners" },
  "author": {
    "@type": "Organization",
    "name": "Abundance Financial Services",
    "url": "https://www.getabundance.in",
    "logo": { "@type": "ImageObject", "url": "https://mfcalc.getabundance.in/logo-og.png", "width": 90, "height": 90 },
    "telephone": "+919808105923",
    "email": "contact@getabundance.in",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "1st Floor, Kapil Complex, Mukhani",
    ...
    "sameAs": [
      ...
      "https://www.facebook.com/abundancefinancialservices",
  ...
  "about": [
    { "@type": "Thing", "name": "Mutual funds in India", "sameAs": "https://en.wikipedia.org/wiki/Mutual_funds_in_India" },
    { "@type": "Thing", "name": "Systematic Investment Plan", "sameAs": "https://en.wikipedia.org/wiki/Systematic_Investment_Plan" },
  ...
  "mentions": [
    { "@type": "Organization", "name": "Association of Mutual Funds in India", "sameAs": "https://www.amfiindia.com" }
  ],
...
<div class="search-card">
  ...
  <div class="search-hint">↳ Live search · Verified data directly from AMFI</div>
...
const FAQ_HTML = `<section class="faq-section" aria-label="Frequently Asked Questions" id="faq">
  <div class="page">
    ...
    <div class="faq-list">
      ...
      <details class="faq-item">
        <summary class="faq-q">How do I compare mutual fund returns between two specific dates or during market crashes?</summary>
        <div class="faq-a">Use the interactive <strong>Fund Compare</strong> chart on this tool. Search and add up to 5 funds, then click and drag across any date window (such as the 2020 COVID crash or recent market corrections). The chart instantly calculates and displays each fund's exact percentage return over that exact window side by side.</div>
      </details>
      <details class="faq-item">
      ...
      <details class="faq-item">
        ...
        <div class="faq-a">Yes, completely free. Built by <strong>Abundance Financial Services®</strong> (ARN-251838), an AMFI-registered Mutual Funds Distributor in Haldwani, Uttarakhand. All NAV data is verified and sourced directly from AMFI. No login required.</div>
      </details>
