...
export default function BacktestLayout({ children }) {
  ...
  const faqs = [
    ...
    ["Where does the NAV data come from?", "Daily NAV history is verified and sourced directly from AMFI for mutual funds, and from the AMFI SIF feed for Specialised Investment Funds. Each instalment is executed at the next available trading-day NAV."],
