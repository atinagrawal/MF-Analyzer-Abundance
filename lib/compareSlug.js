...
export const POPULAR_COMPARISONS = [
  ...
  },
  {
    ...
    pairs: [
      {
        slug: 'icici-prudential-bluechip-fund-vs-nippon-india-large-cap-fund',
        title: 'ICICI Prudential Bluechip vs Nippon India Large Cap',
        highlight: 'Top 2 Actively Managed Bluechip Giants by AUM',
      },
      {
        slug: 'hdfc-top-100-fund-vs-icici-prudential-bluechip-fund',
        title: 'HDFC Top 100 vs ICICI Prudential Bluechip',
        highlight: 'Long-Term Legacy Track Record vs Consistent Benchmark Beater',
      },
      {
        slug: 'hdfc-index-nifty-50-fund-vs-uti-nifty-50-index-fund',
  ...
  },
  {
    ...
    pairs: [
      {
        slug: 'hdfc-mid-cap-opportunities-fund-vs-motilal-oswal-midcap-fund',
        title: 'HDFC Mid-Cap Opportunities vs Motilal Oswal Midcap',
        highlight: 'India’s Largest Mid-Cap Fund vs High-Alpha Focused Mid-Cap',
      },
      {
        slug: 'nippon-india-growth-fund-vs-quant-mid-cap-fund',
        title: 'Nippon India Growth vs Quant Mid Cap',
        highlight: '30-Year Wealth Creation Track Record vs Dynamic Factor Momentum',
      },
      {
        slug: 'kotak-emerging-equity-fund-vs-motilal-oswal-midcap-fund',
        title: 'Kotak Emerging Equity vs Motilal Oswal Midcap',
        highlight: 'Disciplined Growth at Reasonable Price vs High-Beta Growth',
      },
    ],
  },
  {
