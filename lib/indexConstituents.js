...
export function formatIndexMarkdown(detail) {
  ...
  if (valuationStatus && valuationStatus.label && valuationStatus.label !== 'N/A') {
    const descText = valuationStatus.desc ? ` (${valuationStatus.desc})` : '';
    md += `- **Valuation Zone:** ${valuationStatus.label}${descText}\n`;
  }
  md += `\n`;
