...
export const ARTICLES = [
  ...
  },
  {
    ...
    description: "Life Cycle Funds pick a target year and shift from equity to debt on their own. What the glide path and exit-load structure actually are, and who's actually launched one so far.",
