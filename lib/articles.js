 ...
 *
 * Each entry carries its own real publishedDate (YYYY-MM-DD, the actual day
 * it went live) -- never invented or backdated, since that would be exactly
 * the kind of dishonesty this content series argues against. The first 22
 * genuinely all launched together on 2026-08-30; anything published later
 * gets its own later date.
 */
...
export const ARTICLES = [
  ...
  },
  {
    ...
    image: '/articles/loss-aversion-is-costing-you.jpg',
    publishedDate: '2026-08-30',
  },
  {
    ...
    image: '/articles/ill-start-investing-when-i-earn-more.jpg',
    publishedDate: '2026-08-30',
  },
  {
    ...
    image: '/articles/indias-sip-book-milestone.jpg',
    publishedDate: '2026-08-30',
  },
  {
    ...
    image: '/articles/debt-funds-lost-their-tax-edge.jpg',
    publishedDate: '2026-08-30',
  },
  {
  ...
  },
  {
    ...
    image: '/articles/sifs-first-year-of-a-new-asset-class.jpg',
    publishedDate: '2026-08-30',
  },
  {
    ...
    image: '/articles/why-your-pms-statement-looks-different.jpg',
    publishedDate: '2026-08-30',
  },
  {
    ...
    image: '/articles/three-questions-before-any-fund-recommendation.jpg',
    publishedDate: '2026-08-30',
  },
  {
    ...
    image: '/articles/what-risk-actually-taught-me.jpg',
    publishedDate: '2026-08-30',
  },
  {
    ...
    image: '/articles/reading-your-rate-journey-chart.jpg',
    publishedDate: '2026-08-30',
  },
  {
    ...
    image: '/articles/the-worst-timed-sip-instalment.jpg',
    publishedDate: '2026-08-30',
  },
  {
    slug: 'nav-tells-you-nothing',
    file: 'pillar1-nav-tells-you-nothing.md',
    pillar: 'uncomfortable-truth',
    title: "Why Looking at a Fund's NAV Is a Terrible Way to Judge It",
    description: "A ₹22 NAV isn't cheaper than a ₹340 one. NAV alone can't show you performance, cost, risk, or what a fund even holds — here's what to look at instead.",
    image: '/articles/nav-tells-you-nothing.jpg',
    publishedDate: '2026-08-31',
  },
  {
    slug: 'life-cycle-funds-explained',
    file: 'pillar5-life-cycle-funds-explained.md',
    pillar: 'beyond-mutual-funds',
    title: "SEBI's Newest Mutual Fund Category Rebalances Itself. Here's What That Actually Means.",
    description: 'Life Cycle Funds pick a target year and shift from equity to debt on their own. What the glide path and exit-load structure actually are — and why which AMC launched yours matters more than usual.',
    image: '/articles/life-cycle-funds-explained.jpg',
