...
const PAGE_META = {
  ...
  screener: {
    title: 'Mutual Fund Screener — Filter 2,500+ Funds by Return & Risk | Abundance',
    description: 'Screen every regular mutual fund in India by category, 1/3/5-year returns, volatility and drawdown. Sort, filter and compare on real AMFI NAVs. Free tool by Abundance Financial Services.',
    keywords: 'mutual fund screener India, MF screener, best mutual funds by returns, fund comparison, equity fund screener, debt fund screener, ELSS screener, volatility drawdown, AMFI NAV, Abundance Financial Services',
    path: '/screener',
  ...
  proposalStudio: {
    ...
    description: "Build a mutual fund or SIF investment proposal — see combined sector/security exposure, fund overlap, and Large/Mid/Small-cap allocation using AMFI's official categorization. Premium tool by Abundance Financial Services (ARN-251838).",
  ...
  'portfolio': {
    title: 'My Portfolio — Track Mutual Funds with Live NAVs | Abundance',
    description: 'Your personal mutual fund portfolio dashboard. Track all holdings with live AMFI NAVs, FIFO capital gains, ELSS lock-in, SIF holdings, and family CAS multi-PAN support. Free for clients of Abundance Financial Services, ARN-251838, Haldwani.',
    keywords: 'mutual fund portfolio tracker India, live NAV portfolio dashboard, FIFO capital gains calculator mutual fund, ELSS lock-in tracker, family CAS multi PAN, SIF holdings tracker, Abundance Financial Services ARN-251838',
    path: '/portfolio',
