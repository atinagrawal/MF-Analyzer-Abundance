...
const PAGE_META = {
  ...
  'sip-calculator': {
    title: 'SIP Calculator India — Systematic Investment Plan & Step-Up Returns | Abundance',
    description: 'Free SIP calculator to project future wealth with monthly SIP, annual Step-Up %, and lumpsum comparisons. Backtest against real historical AMFI NAV data with XIRR. Free tool by Abundance Financial Services ARN-251838.',
    keywords: 'SIP calculator, SIP calculator India, step up SIP calculator, mutual fund SIP return calculator, SIP return formula, lumpsum vs SIP calculator, SIP NAV backtester, XIRR calculator mutual fund, Abundance Financial Services ARN-251838',
    path: '/sip-calculator',
    ogImage: '/og-mfcalc.png',
    changefreq: 'weekly',
    priority: 0.90,
  ...
  'swp-calculator': {
    title: 'SWP Calculator India — Systematic Withdrawal Plan & Real NAV Backtester | Abundance',
    description: 'Calculate monthly retirement income, corpus longevity runway, and sustainable withdrawal rates with inflation adjustment. Replay real AMFI mutual fund NAV history with exact XIRR. Free tool by Abundance Financial Services ARN-251838.',
    keywords: 'SWP calculator, SWP calculator India, systematic withdrawal plan calculator, retirement SWP calculator, SWP longevity calculator, SWP NAV backtester, mutual fund monthly income, SWP vs FD, Abundance Financial Services ARN-251838',
    path: '/swp-calculator',
    ogImage: '/og-mfcalc.png',
    changefreq: 'weekly',
    priority: 0.90,
  ...
  'cas-tracker': {
    title: 'CAS Portfolio Tracker — Live NAV, FIFO Gains & Quartile Ranking | Abundance',
    description: 'Upload your CAMS or KFintech CAS PDF to track all mutual fund holdings with live AMFI NAVs, FIFO capital gains, ELSS 3-year lock-in status, SIF holdings, an exit-load-aware redemption planner, and multi-PAN family support with an editable family name. New: a Portfolio Review report ranks every holding into a 1Yr/3Yr/5Yr performance quartile against its category peers. Free tool by Abundance Financial Services, ARN-251838.',
    keywords: 'CAS portfolio tracker, CAMS statement upload, KFintech CAS parser, mutual fund portfolio tracker India, live NAV tracker AMFI, mutual fund quartile ranking, portfolio review report mutual fund, peer category fund comparison, ELSS lock-in calculator, FIFO capital gains mutual fund, exit load calculator mutual fund, redemption planner mutual fund India, mutual fund exit load checker, family CAS multi PAN, family name portfolio, consolidated account statement analyser, SIF holdings tracker, mutual fund transaction history, NAV rate chart mutual fund, mutual fund transmission tracker, inherited mutual fund units, transmission in mutual fund folio, Abundance Financial Services, ARN-251838',
    path: '/cas-tracker',
    ogImage: '/og-cas.png',
    changefreq: 'monthly',
    priority: 0.85,
  ...
  'portfolio': {
    ...
    description: 'Your personal mutual fund portfolio dashboard. Track all holdings with live AMFI NAVs, portfolio XIRR, FIFO capital gains, ELSS lock-in, SIF holdings, an exit-load-aware redemption planner, and family CAS multi-PAN support. Free for clients of Abundance Financial Services, ARN-251838, Haldwani.',
    keywords: 'mutual fund portfolio tracker India, live NAV portfolio dashboard, portfolio XIRR calculator, FIFO capital gains calculator mutual fund, exit load calculator mutual fund, redemption planner mutual fund India, ELSS lock-in tracker, family CAS multi PAN, SIF holdings tracker, Abundance Financial Services ARN-251838',
    path: '/portfolio',
  ...
  indices: {
    title: 'NSE & BSE Index Dashboard — Returns, P/E Valuation & TRI for 270+ Indices | Abundance',
    description: 'Track 270+ NSE & BSE market indices: 1M–5Y TRI returns, P/E & P/B valuation gauges, Beta, and Volatility. Benchmark Nifty 50, Sensex, Midcap 150 & Smallcap 250 against mutual funds. Free tool by Abundance Financial Services (ARN-251838).',
    keywords: 'NSE index dashboard, BSE Sensex returns, Nifty 50 PE ratio today, Indian stock market valuation, total return index TRI, Nifty Midcap 150 PE ratio, Nifty Smallcap 250 returns, BSE 500 valuation, index comparison India, mutual fund benchmark comparison, Nifty sectoral indices, Nifty factor indices, Abundance Financial Services ARN-251838',
    path: '/indices',
  ...
  'pms-preferred': {
    ...
    description: 'PMS strategies that are Top Quartile vs APMI peers, with real extracted holdings, sector allocation and fundamentals. Curated by disclosed, factual criteria -- not investment advice. By Atin Kumar Agrawal, APMI Registered PMS Distributor (APRN04279), Abundance Financial Services.',
  ...
  'book-consultation': {
    title: 'Book a Free Mutual Fund Consultation — AMFI Registered MFD | Abundance',
    description: 'Book a free 30-minute call with Abundance Financial Services — Atin Kumar Agrawal, AMFI-registered MF & SIF Distributor (ARN-251838) and APMI Registered PMS Distributor (APRN04279), with 15+ years experience, ₹250Cr+ AUM and 350+ clients. Personalised guidance on mutual funds, SIP, SWP, SIF & PMS. No obligation, email-verified booking.',
    keywords: 'book mutual fund consultation, free financial advisor call India, SEBI registered mutual fund distributor consultation, book a call with financial advisor, free SIP planning consultation, mutual fund advisor Haldwani, book investment advice call, personal finance consultation free India, talk to mutual fund advisor, ARN-251838, Abundance Financial Services consultation',
    path: '/book-consultation',
    ogImage: '/api/og-book-consultation',
    changefreq: 'monthly',
    priority: 0.85,
  },
  ...
  articles: {
    title: 'Articles — Honest Mutual Fund, PMS & SIF Writing | Abundance',
    description: 'Practical, honest articles on mutual funds, PMS and SIF from an AMFI Registered Mutual Funds & SIF Distributor (ARN-251838) — exit loads, riskometers, SIP behaviour, and what the fine print actually means for you.',
    keywords: 'mutual fund articles India, SIP investing blog, exit load explained, riskometer explained, direct vs regular mutual fund, PMS vs mutual fund, SIF explained India, mutual fund investor education, Abundance Financial Services articles, ARN-251838',
    path: '/articles',
    ogImage: `/api/og-article?title=${encodeURIComponent('Honest, practical writing on mutual funds, PMS & SIF')}&pillar=${encodeURIComponent('Articles')}`,
    changefreq: 'weekly',
    priority: 0.8,
  },

  nfo: {
    title: 'Live NFO Tracker India 2026 — Mutual Fund & SIF New Fund Offers | Abundance',
    description: 'Track all mutual fund and SIF New Fund Offers (NFOs) open for subscription in India. Live AMFI data with launch/closing dates, offer price ₹10, minimum investment & official SID offer documents. Free tool by Abundance (ARN-251838).',
    keywords: 'NFO India, new fund offer, mutual fund NFO today, SIF NFO India, Specialised Investment Fund NFO, live NFOs open now, new fund offers 2026, Altiva SIF, upcoming mutual fund launch, AMFI new fund offer, NFO closing dates, mutual fund subscription, Abundance Financial Services ARN-251838',
    path: '/nfo',
    ogImage: '/api/og-nfo',
    changefreq: 'daily',
    priority: 0.90,
  ...
  amc: {
    ...
    description: 'Explore all 52 mutual fund asset management companies (AMCs) in India. Compare total official AMFI AUM, active equity & hybrid scheme counts, 3Y returns, and fund managers. Abundance Financial Services (ARN-251838) · Atin Kumar Agrawal (APRN04279).',
    keywords: 'mutual fund AMCs India, list of AMCs, fund houses India, HDFC mutual fund, SBI mutual fund, ICICI prudential AMC, AMC AUM rankings India, mutual fund managers India, AMFI registered fund houses',
    path: '/amc',
    ogImage: '/og-mfcalc.png',
    changefreq: 'daily',
    priority: 0.85,
  ...
  'pms-provider': {
    ...
    description: 'Explore all 19 tracked PMS providers in India including Carnelian, Abakkus, Alchemy, Motilal Oswal, ValueQuest, ICICI Prudential, and more. View active strategies, monthly factsheets, and deep-link to APMI performance analytics. Abundance Financial Services (ARN-251838) · Atin Kumar Agrawal (APRN04279).',
    keywords: 'PMS providers India, portfolio management services directory, Carnelian PMS, Abakkus PMS, Alchemy PMS, Motilal Oswal PMS, ValueQuest PMS, PMS factsheets download, APMI registered PMS',
    path: '/pms-provider',
    ogImage: '/og-pms-screener.png',
    changefreq: 'weekly',
    priority: 0.85,
...
// Add entries for every individual /articles/[slug] page. Takes the
// articles list as a parameter (rather than importing lib/articles.js
// directly) to avoid this file needing to know that module's shape --
// same reasoning as getScreenerCategorySitemapEntries above.
export function getArticlesSitemapEntries(articles) {
