...
const PAGE_META = {
  ...
  'cas-tracker': {
    title: 'CAS Portfolio Tracker & Live NAV Analyser | Abundance',
    description: 'Securely upload your CAMS or KFintech Consolidated Account Statement (CAS). Parse your mutual fund holdings locally to track live NAVs, ELSS lock-ins, and accurate FIFO wealth gains.',
    keywords: 'CAS upload, CAMS statement tracker, mutual fund portfolio tracker, live NAV tracker, ELSS lock-in calculator, FIFO capital gains, Abundance Financial Services, Family CAS Analyzer, KFintech CAS parser',
    path: '/cas-tracker',
    ogImage: '/og-cas.png',
    changefreq: 'monthly',
    priority: 0.80,
