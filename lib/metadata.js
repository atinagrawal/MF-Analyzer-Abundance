...
const PAGE_META = {
  ...
  'pms-provider': {
    ...
    description: 'Explore all 18 tracked PMS providers in India including Carnelian, Abakkus, Alchemy, Motilal Oswal, ICICI Prudential, and more. View active strategies, monthly factsheets, and deep-link to APMI performance analytics. Abundance Financial Services (ARN-251838) · Atin Kumar Agrawal (APRN04279).',
    keywords: 'PMS providers India, portfolio management services directory, Carnelian PMS, Abakkus PMS, Alchemy PMS, Motilal Oswal PMS, PMS factsheets download, APMI registered PMS',
    path: '/pms-provider',
    ogImage: '/og-pms-screener.png',
    changefreq: 'weekly',
    priority: 0.85,
