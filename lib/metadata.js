...
const PAGE_META = {
  ...
  'cas-tracker': {
    ...
    description: 'Upload your CAMS or KFintech CAS PDF to track all mutual fund holdings with live AMFI NAVs, FIFO capital gains, ELSS 3-year lock-in status, SIF holdings, per-transaction NAV rate charts, an exit-load-aware redemption planner, and multi-PAN family support. Free tool by Abundance Financial Services, ARN-251838.',
    keywords: 'CAS portfolio tracker, CAMS statement upload, KFintech CAS parser, mutual fund portfolio tracker India, live NAV tracker AMFI, ELSS lock-in calculator, FIFO capital gains mutual fund, exit load calculator mutual fund, redemption planner mutual fund India, mutual fund exit load checker, family CAS multi PAN, consolidated account statement analyser, SIF holdings tracker, mutual fund transaction history, NAV rate chart mutual fund, mutual fund transmission tracker, inherited mutual fund units, transmission in mutual fund folio, Abundance Financial Services, ARN-251838',
    path: '/cas-tracker',
    ogImage: '/og-cas.png',
    changefreq: 'monthly',
    priority: 0.85,
