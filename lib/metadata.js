...
const PAGE_META = {
  ...
  'mfc-portfolio': {
    title: 'MF Central Portfolio Tracker — Live NAV Holdings View | Abundance',
    description: 'Upload your MF Central Consolidated Account Statement PDF for an instant live-NAV portfolio view. No password required. Covers all AMCs across CAMS & KFintech. Free tool by Abundance Financial Services.',
    keywords: 'MF Central portfolio tracker, MF Central CAS upload, mutual fund holdings live NAV, AMFI NAV portfolio, MF Central statement analyser, mutual fund portfolio India, Abundance Financial Services ARN-251838',
    path: '/mfc-portfolio',
    ogImage: '/og-cas.png',
    changefreq: 'monthly',
    priority: 0.85,
