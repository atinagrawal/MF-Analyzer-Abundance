...
*An Uncomfortable Truth from Abundance Financial Services · Atin Kumar Agrawal, ARN-251838*
...
- **How the fund actually performed.** ₹10 growing to ₹22 and ₹10 growing to ₹15 both describe funds with completely different NAVs today depending only on when they launched — NAV alone can't even tell you which of two funds compounded faster, because you'd need to know each one's starting NAV and time period just to begin comparing.
- **What it costs you.** Expense ratio, exit load, the Direct-vs-Regular gap — none of this shows up in the NAV figure at all.
- **What it actually holds.** A fund's NAV says nothing about whether it's concentrated in ten stocks or diversified across two hundred, whether it's tilted large-cap or small-cap, or whether its biggest holding is 4% of the portfolio or 40%.
- **How risky it's been.** Two funds can sit at an identical NAV today having taken wildly different paths to get there — one steady, one halving and doubling twice along the way. The number at the end looks the same either way.
- **Whether it's "cheap" or "expensive" in any real sense.** This is the one that trips people up most, and it deserves its own section.
...
- **CAGR across multiple periods** (1Y, 3Y, 5Y, since inception) — the actual rate your money would have compounded at, which is what NAV-alone can never show without a starting point and a date attached.
- **Expense ratio and the Direct/Regular gap** — what the fund actually costs you every year.
- **Category and portfolio composition** — what you're actually invested in, not what number is printed next to it.
- **Volatility and drawdown** — how rough the ride was to get to today's number.
- **Consistency versus the benchmark** — whether it beat its index reliably, or got lucky once.
...
*Atin Kumar Agrawal, Abundance Financial Services — ARN-251838 (AMFI Registered Mutual Funds & SIF Distributor). Compare funds by what actually matters on our [screener](/screener) — or [book a free consultation](/book-consultation) if a "cheap NAV" pitch is the reason you're considering a fund.*
